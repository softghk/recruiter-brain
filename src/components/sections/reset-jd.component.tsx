...
const ResetJDModal = ({
  ...
  return (
    <Modal disablePortal disableScrollLock open={open} sx={{ zIndex: 9999 }}>
      <Box
        sx={{
          padding: 3,
          position: "absolute",
        ...
        <Stack gap={3}>
          ...
          <Box>
            <Typography variant="body1" color={"gray"}>
              Evaluations rely on this job description: resetting it will erase
              all existing evaluations.
            </Typography>
          </Box>
